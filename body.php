...
<body>
    ...
    <section class="container">
      <div class="grid-container" id="grid1">
          <div class="item6">
              <h1 class="d-flex justify-content-center"><b>Body Building Program</b> </h1>
              <h5 class="mt-4 tag">Body building is the use of progressive resistance exercise to control and develop one's muscles
                 by muscle hypertrophy for aesthetic purposes.</h5>
              <h5 class="mt-2 tag">Body Building program mentored by <b> Chris David</b>. You can have access to exerciss of this program and 
