...
<body>
    ...
    <section class="container">
      <div class="grid-container" id="grid1">
          <div class="item6">
              <h1 class="d-flex justify-content-center"><b>Cardio Program</b> </h1>
              <h5 class="mt-4 tag">Cardio Exercise is physical exercise of low to high intensity 
                  that depends primarily on the aerobic energy-generating process.</h5>
              <h5 class="mt-2 tag">Cardio program mentored by <b>Emma Paul</b> . You can have access to exerciss of this program and 
