...
<body>
            ...
            <div class="top-header">
                <div id="topshead" class="row">
                    ...
                    <div id="lefts" class="col-sm-6">
                        ...
                        <a id="ic leftpane" style = "color:black;" href="bbdp.png" download><i class="fas fa-download"></i></a>
                    </div>
                </div>
            </div>
        </section>
  ...
  <div class="overlay-content">
    <form action="/action_page.php">
      <img src="bbdp.png" alt="">
    </form>
  </div>
</div>

        <section>
            <h1 class="text-center mt-4" style="font-family: 'Moon Dance', cursive;"><dt>Body Building Exercises</dt></h1>
        </section>
...
<div id="myCarousel" class="carousel slide border-dark rounded border-left border-right border-top" data-ride="carousel">
  ...
  <div class="carousel-item active" data-slide-number="0">
    ...
    <div class="center">
        <div class = "boxed text-center font-weight-bold">Back Press</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="backpresses.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Barbell Curls</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="barbell_Curls.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Barbell Front Raises</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="barbell_Front_Raises.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Bench Press</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Concentration Curls</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="concentrationcurls.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class = "boxed text-center font-weight-bold">Decline Pushups</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="decline_pushups.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">One Arm Tricep Extension</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="one_arm_tricep_ext.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Power Squats</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="power_Squats.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Rowing</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="rowing.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Seated Dumbell Press</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="seated_dumbell_presses.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Tricep Extension</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="tricep_extension.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Upright Rows</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="upright_rows.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="carousel-item active">
      <div class="row mx-0">
        <div id="carousel-selector-0" class="thumb col-4 col-sm-2 px-1 py-2 selected" data-target="#myCarousel" data-slide-to="0">
          <video src="backpresses.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-1" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="1">
        <video src="barbell_Curls.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-2" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="2">
        <video src="barbell_Front_Raises.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-3" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="3">
        <video src="benchpress.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-4" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="4">
        <video src="concentrationcurls.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-5" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="5">
        <video src="decline_pushups.mp4" class="img-fluid" alt="..."></video>
        </div>
      </div>
    </div>
